  ...
  Widget build(BuildContext context) {
    return Scaffold(
       ...
       appBar: AppBar(
        ...
        title: Text('Doa shalat hajat',style: GoogleFonts.poppins(
          textStyle:TextStyle(
            ...
            children: [
               ...
               Padding(
                ...
                child: Container(
                  ...
                  width: MediaQuery.of(context).size.width,
                  color: Colors.white,
                  child: Text('سُبحْانَ الذِّيْ لَبِسَ العِزَّ وَقاَلَ بهِ سُبحْانَ الذِّيْ'
               ...
               Padding(
                padding: const EdgeInsets.symmetric(horizontal: 20),
                child: Text('Maha suci Allah yang bersifat kemuliaan dan Dia berfirman dengannya. Maha suci Allah yang mempunyai sifat yang ketinggian dan menjadi mulia dengannya, Maha suci Allah yang meliputi ilmu-Nya tidak kepada orang lain. Maha suci Allah yang mempunyai kelebihan dan pemberian.'+' Maha suci Allah yang mempunyai kebesaran dan kemuliaan. Maha suci Allah yang pemberian dan Nikmat. Daku memohon dengan rahmat-Mu dari kitab-Mu dan dengan nama-Mu yang mulia,kehormatan-Mu yang sempurna yang tidak dapat di atasi oleh segala kebaikan dan kejahatan. Sesungguhnya Kau bershalawat keatas Nabi Muhammad SAW dan keatas ahli keluarganya',style: GoogleFonts.roboto(
                  textStyle:TextStyle(
                    height: 1.5,
