    ...
    return Scaffold(
      ...
      backgroundColor: Colors.white,
       appBar: AppBar(
        ...
        title: Text('أستغاثة أمانة الأمة',style: GoogleFonts.poppins(
          textStyle:TextStyle(
             ...
             SizedBox(height: 30,),
               Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Text('(1x)  الفَاتِحَة',style: GoogleFonts.poppins(
                      textStyle:TextStyle(
                        color:Colors.black,
                       fontSize: size
                      )
               ...
               Padding(
                ...
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.end,
                  children: [
                    Text('(3x) سورة الإخلاص ',style: GoogleFonts.poppins(
                      textStyle:TextStyle(
                        color:Colors.black,
                       fontSize: size
                      )
              ...
              SizedBox(height: 50,),
               Padding(
                ...
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.end,
                  children: [
                    Text('(7x) لاَ إِلهَ إِلاَّالله ',style: GoogleFonts.poppins(
                      textStyle:TextStyle(
                        color:Colors.black,
                       fontSize: size
                      )
               ...
               Padding(
                padding: const EdgeInsets.symmetric(horizontal: 20),
                child: Text(' أسْتَغْفِرُ اللهَ العَظِيْمَ وَأتُوبُ إلَيْهِ '+'  (7x) ',
               ...
               Padding(
                padding: const EdgeInsets.symmetric(horizontal: 20),
                child: Text(' أسْتَغْفِرُ اللهَ العَظِيْمَ إنَّهُ كاَنَ غَفَّارًا '+'  (7x) ',
                textDirection: TextDirection.rtl,
                style: GoogleFonts.poppins(
                  textStyle:TextStyle(
                    color:Colors.black,
               ...
               Padding(
                padding: const EdgeInsets.symmetric(horizontal: 20),
                child: Text('اللهُمَّ صَلِّ عَلَى سَيّدِنَا مُحَمَّدٍ وَعَلَى آلِهِ وَصَحْبهِ '+' وَبَارِكْ وَسَلِّمْ '+'  (7x)',
                textDirection: TextDirection.rtl,
                style: GoogleFonts.poppins(
                  textStyle:TextStyle(
                    color:Colors.black,
      ...
      SizedBox(height: 50,),
               Padding(
                padding: const EdgeInsets.symmetric(horizontal: 20),
                child: Text('لاَإلَهَ إلاَّ أَنْتَ سُبْحَانَكَ إنِّى كُنْتُ مِنَ الظَّالِمِيْنَ '+'  (7x)',
                textDirection: TextDirection.rtl,
                style: GoogleFonts.poppins(
                  textStyle:TextStyle(
                    color:Colors.black,
              ...
              SizedBox(height: 50,),
               Padding(
                padding: const EdgeInsets.symmetric(horizontal: 20),
                child: Text('سُبْحَانَ اللهِ وَالْحَمْدُ للهِ وَلاَإلَهَ إلاَّ اللهُ أكْبَرُ '+'  (7x)',
                textDirection: TextDirection.rtl,
                style: GoogleFonts.poppins(
                  textStyle:TextStyle(
                    color:Colors.black,
               ...
               Padding(
                padding: const EdgeInsets.symmetric(horizontal: 20),
                child: Text('لاَحَوْلَ وَلاَقُوَّةَ إلاَّ بِااللهِ العَلِيّ الْعَظِيْمِ  '+'  (9x)',
                textDirection: TextDirection.rtl,
                style: GoogleFonts.poppins(
                  textStyle:TextStyle(
                    color:Colors.black,
               ...
               Padding(
                padding: const EdgeInsets.symmetric(horizontal: 20),
                child: Text(' حَسْبُنَا اللهُ وَنِعْمَ الْوَكِيْلِ نِعْمَ الْمَوْلَى وَنِعْمَ '+'النَّصِيْرُ'+'  (7x)',
                textDirection: TextDirection.rtl,
                style: GoogleFonts.poppins(
                  textStyle:TextStyle(
                    color:Colors.black,
             ...
             SizedBox(height: 50,),
               ...
               Padding(
                padding: const EdgeInsets.symmetric(horizontal: 20),
                child: Text('رَبَّنَا زِدْنَا عُلُوْمًا نَافِعةً وَارْزُقْنَا أعْمَالاً مُتَقَبَّلَةً '+'  (7x)',
                textDirection: TextDirection.rtl,
                style: GoogleFonts.poppins(
                  textStyle:TextStyle(
                    color:Colors.black,
               ...
               Padding(
                ...
                child: Text('وَذَلّلْنَاهَا لَهُمْ فَمِنْهَا رَكُوْبُهُمْ وَمِنْهَا يَاءْكُلُوْنَ '+'  (9x)',
                 textDirection: TextDirection.rtl,
                style: GoogleFonts.poppins(
                  textStyle:TextStyle(
                    color:Colors.black,
               ...
               Padding(
                padding: const EdgeInsets.symmetric(horizontal: 15),
                child: Text('رَبَّنَا إنَّكَ جَمِعُ النَّاسِ لِيَوْمِ لاَرَيْبَ فِيْهِ إنَّ اللهَ '+'لاَيُخْلِفُ الْمِعَادَ'+'  (7x)',
                textDirection: TextDirection.rtl,
                style: GoogleFonts.poppins(
                  textStyle:TextStyle(
                    color:Colors.black,
             ...
             Padding(
               ...
               child: Container(
                ...
                color: color,
                width: MediaQuery.of(context).size.width ,
                child: Text('(2×) أَشْهَدُ أَن لَّا إِلَٰهَ إِلَّا ٱللَّٰهُ',
                textDirection: TextDirection.rtl,
                style: TextStyle(
                  color: Colors.black,
                  fontSize: size,
             ...
             Padding(
               ...
               child: Container(
                ...
                color: color,
                width: MediaQuery.of(context).size.width ,
                child: Text('(2×) أَشْهَدُ أَنَّ مُحَمَّدًا رَسُولُ ٱللَّٰهِ',
                textDirection: TextDirection.rtl,
                style: TextStyle(
                  color: Colors.black,
                  fontSize: size,
             ...
             Padding(
               ...
               child: Container(
                ...
                color: color,
                width: MediaQuery.of(context).size.width ,
                child: Text('(2×) حَيَّ عَلَى ٱلصَّلَاةِ',
                textDirection: TextDirection.rtl,
                style: TextStyle(
                  color: Colors.black,
                  fontSize: size,
             ...
             Padding(
               ...
               child: Container(
                ...
                color: color,
                width: MediaQuery.of(context).size.width ,
                child: Text('(2×) حَيَّ عَلَى ٱلْفَلَاحِ',
                textDirection: TextDirection.rtl,
                style: TextStyle(
                  color: Colors.black,
                  fontSize: size,
             ...
             Padding(
               ...
               child: Container(
                ...
                color: color,
                width: MediaQuery.of(context).size.width ,
                child: Text('(2×) ٱللَّٰهُ أَكْبَرُ',
                textDirection: TextDirection.rtl,
                style: TextStyle(
                  color: Colors.black,
                  fontSize: size,
             ...
             Padding(
               ...
               child: Container(
                ...
                color: color,
                width: MediaQuery.of(context).size.width ,
                child: Text('(1×) لَا إِلَٰهَ إِلَّا ٱللَّٰهُ',
                textDirection: TextDirection.rtl,
                style: TextStyle(
                  color: Colors.black,
                  fontSize: size,
        ...
        SizedBox(height: 50,),
         ...
         SizedBox(height: 50,),
               Padding(
                padding: const EdgeInsets.symmetric(horizontal: 15),
                child: Text('ثُمَّ أَنزَلَ عَلَيْكُم مِّنۢ بَعْدِ ٱلْغَمِّ أَمَنَةً نُّعَاسًا'
                ...
                +'لَبَرَزَ ٱلَّذِينَ كُتِبَ عَلَيْهِمُ ٱلْقَتْلُ إِلَىٰ مَضَاجِعِهِمْ'+' ۖ '
           ...
           SizedBox(height: 50,),
             Padding(
                padding: const EdgeInsets.symmetric(horizontal: 15),
                child: Text('مُحَمَّدٌ رَّسُوْلُ اللّٰهِ ۗوَالَّذِيْنَ مَعَهٗٓ اَشِدَّاۤءُ عَلَى'
            ...
            SizedBox(height: 50,),
               ...
               Padding(
                padding: const EdgeInsets.symmetric(horizontal: 15),
                child: Text(' لَقَدْ جَاءَكُمْ رَسُولٌ مِنْ أَنْفُسِكُمْ عَزِيزٌ عَلَيْهِ مَا '
             ...
             Padding(
                padding: const EdgeInsets.symmetric(horizontal: 15),
                child: Text('لَوْ أَنزَلْنَا هَٰذَا ٱلْقُرْءَانَ عَلَىٰ جَبَلٍ لَّرَأَيْتَهُۥ خَٰشِعًا'
          ...
          SizedBox(height: 50,),
            ...
            SizedBox(height: 5,),
               Padding(
                padding: const EdgeInsets.symmetric(horizontal: 15),
                child: Text(' يَاهَادِي يَاعَلِيْمُ يَاخَبِيْرُ يَافَتَّاحُ يَامُبِيْن '+'  (7x)',
                textDirection: TextDirection.rtl,
                style: GoogleFonts.poppins(
                  textStyle:TextStyle(
                    color:Colors.black,
               ...
               SizedBox(height: 50,),
                 ...
                 Padding(
                padding: const EdgeInsets.symmetric(horizontal: 15),
                child: Text('وَمَا قَدَرُوا اللَّهَ حَقَّ قَدْرِهِ وَالْأَرْضُ جَمِيعًا'
            ...
            SizedBox(height: 50,),
               Padding(
                ...
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.end,
                  children: [
                    Text(' يَاحَيُّ يَاقَيُّوْمُ بِرَحْمَتِكَ أسْتَغِيْثُ',
                    textDirection: TextDirection.rtl,
                    style: GoogleFonts.poppins(
                      textStyle:TextStyle(
                        color:Colors.black,
               ...
               Padding(
                padding: const EdgeInsets.symmetric(horizontal: 15),
                child: Text(' رَبَّنَاتَقَبَّلْ مِنَّا إنَّكَ أنْتَ السَّمِيْعُ العَلِيْمُ'+'وَتُبْ عَلَيْنَا إنَّكَ أنْتَ التَّوَّابُ الرَّحِيْمُ',
                textDirection: TextDirection.rtl,
                style: GoogleFonts.poppins(
                  textStyle:TextStyle(
                    color:Colors.black,
              ...
              SizedBox(height: 50,),
               Padding(
                padding: const EdgeInsets.symmetric(horizontal: 15),
                child: Text('وَصَلَّى اللهُ عَلَى سَيِّدِنَا مُحَمَّدٍ وَعَلَى آلِهِ وَصَحْبِهِ'+'وَسَلَّمَ وَالْحَمْدُ للهِ رَبِّ الْعَالَمِيْنَ. ( الفاتحة )',
                textDirection: TextDirection.rtl,
                style: GoogleFonts.poppins(
                  textStyle:TextStyle(
                    color:Colors.black,
