  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Al Fatihah',style: GoogleFonts.poppins(
          textStyle:TextStyle(
          ...
          child: Column(
            ...
            SizedBox(height: 40,),
             Container(
              ...
              color: color,
              width: MediaQuery.of(context).size.width ,
              child: Text('الْحَمْدُ لِلَّهِ رَبِّ الْعَالَمِينَ'+'   - '+'١',
              textDirection: TextDirection.rtl,
              style: TextStyle(
                fontFamily: 'LPMQ',
                color: Colors.black,
             ...
             Container(
              ...
              color: color,
              width: MediaQuery.of(context).size.width ,
              child: Text('الرَّحْمَنِ الرَّحِيمِ'+'   - '+'٢',
              textDirection: TextDirection.rtl,
              style: TextStyle(
             ...
             Container(
              ...
              color: color,
              width: MediaQuery.of(context).size.width ,
              child: Text('مَالِكِ يَوْمِ الدِّينِ'+'   - '+'٣',
              textDirection: TextDirection.rtl,
              style: TextStyle(
                color: Colors.black,
                fontSize: size,
             ...
             Container(
              ...
              color: color,
              width: MediaQuery.of(context).size.width ,
              child: Text('إِيَّاكَ نَعْبُدُ وَإِيَّاكَ نَسْتَعِينُ'+'   - '+'٤',
              textDirection: TextDirection.rtl,
              style: TextStyle(
                color: Colors.black,
                fontSize: size,
             ...
             Container(
              ...
              color: color,
              width: MediaQuery.of(context).size.width ,
              child: Text('اهْدِنَا الصِّرَاطَ الْمُسْتَقِيمَ'+'   - '+'٥',
              textDirection: TextDirection.rtl,
              style: TextStyle(
                color: Colors.black,
                fontSize: size,
             ...
             Container(
              ...
              color: color,
              width: MediaQuery.of(context).size.width ,
              child: Text('صِرَاطَ الَّذِينَ أَنْعَمْتَ عَلَيْهِمْ غَيْرِ الْمَغْضُوبِ عَلَيْهِمْ وَلَا الضَّالِّينَ'+' - '+'٦',
              textDirection: TextDirection.rtl,
              style: TextStyle(
                color: Colors.black,
                fontSize: size,
