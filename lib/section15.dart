  ...
  Widget build(BuildContext context) {
    return Scaffold(
       ...
       appBar: AppBar(
        ...
        title: Text('Doa menghilangkan kantuk & malas',style: GoogleFonts.poppins(
          textStyle:TextStyle(
            ...
            children: [
              SizedBox(height: 40,),
                ...
                child: Container(
                  ...
                  width: MediaQuery.of(context).size.width,
                  color: Colors.white,
                  child: Text('لَااِلَهَ اِلاَّااللُه الوَاحِدُالقَهَّارُرَبُّ السَّمَاوَاتِ '
                  +' '+'وَالَارْضِ وَمَابَيْنَهُمَاالعَزِيْزُالغَفَّارُ'
